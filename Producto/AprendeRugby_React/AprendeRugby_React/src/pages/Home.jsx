    ...
    <div className="home-container">
      ...
      <nav className="navbar">
        ...
        <div className="nav-links">
          <span 
            className={pestañaActiva === 'reglamento' ? 'nav-item-active' : ''} 
            onClick={() => setPestañaActiva('reglamento')}
      ...
      <div className="main-layout">
        ...
        {/* INICIO */}
          ...
          {pestañaActiva === 'reglamento' && (
            <div className="reglamento-view">
              <div className="hero-banner" style={{ marginBottom: '20px' }}>
                <h1>Reglamento Oficial</h1>
              </div>
              {/* Renderiza el componente de reglamento ocupando el área principal */}
              <Reglamento />
            </div>
          )}
